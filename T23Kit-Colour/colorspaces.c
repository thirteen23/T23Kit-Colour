...
static pixel_t RGB2XYZ[3] = {{0.41240f, 0.21260f, 0.01930f, 0.0f},
                             {0.35760f, 0.71520f, 0.11920f, 0.0f},
                             {0.18050f, 0.07220f, 0.95050f, 0.0f}};

static pixel_t XYZ2RGB[3] = {{3.24060f, -0.9689f, 0.05570f, 0.0f},
                             {-1.5372f, 1.87580f, -0.2040f, 0.0f},
                             {-0.4986f, 0.04150f, 1.05700f, 0.0f}};
