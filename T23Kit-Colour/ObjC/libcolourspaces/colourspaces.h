...
/* Helpers */
void _print_pixel_double_(pixel_t p);

/* Distance Metrics */
void _cie76_double_(pixel_t lab, pixel_t plab,
                                         colour_val_t *dl);

void _cmc1984_double_(pixel_t lab, pixel_t plab,
                                           colour_val_t l, colour_val_t c,
                                           colour_val_t *dl);

void _cie94_double_(pixel_t lab, pixel_t plab, int media,
                                         colour_val_t *dl);

void _ciede2000_double_(pixel_t lab, pixel_t plab,
...
/* Helpers */
void _print_pixel_float_(pixel_t p);

/* Distance Metrics */
void _cie76_float_(pixel_t lab, pixel_t plab,
                                        colour_val_t *dl);

void _cmc1984_float_(pixel_t lab, pixel_t plab,
                                          colour_val_t l, colour_val_t c,
                                          colour_val_t *dl);

void _cie94_float_(pixel_t lab, pixel_t plab, int media,
                                        colour_val_t *dl);

void _ciede2000_float_(pixel_t lab, pixel_t plab,
                                            colour_val_t kl, colour_val_t kc,
                                            colour_val_t kh,
                                            colour_val_t *dl);
